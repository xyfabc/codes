...
typedef	int (FrameDataCallBack)(void *frameBuf, long frameLength,unsigned long long u64pts,unsigned int  cameraId, void *args);
...
class CRTSPSession : public QObject
{
    Q_OBJECT
public:
    CRTSPSession();
