...
void CRTSPSession::rtsp_fun()
{
    ...
    //char rtspURL[128]= {"rtsp://192.168.8.24:9000/h264ESVideoTest9000"};

    char rtspURL[128]= {"rtsp://192.168.8.24:8554/123.zmj"};

    if(strcmp(cameraInfo.struIP.sIpV4, "192.168.8.24") != 0){
