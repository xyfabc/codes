/*
 * linux/include/asm-mips/mach-jz4775/jz4775bch.h
 *
 * JZ4775 bch register definition.
 *
 * Copyright (C) 2012 Ingenic Semiconductor Co., Ltd.
 */

#ifndef __JZ4775BCH_H__
#define __JZ4775BCH_H__
...
#define BCH_BHEA	(BCH_BASE + 0x198) /* BCH Erase Analyzer register */
...
#define REG_BCH_BHEA	REG32(BCH_BHEA)
...
/* BCH Erase Analyzer register */
#define BCH_BHEA_ZBE	(1 << 0)
#define BCH_BHEA_TZB_BIT	16
#define BCH_BHEA_TZB_MASK	(0xFF << BCH_BHEA_TZB_BIT)
#define BCH_BHEA_ZB_BIT	24
#define BCH_BHEA_ZB_MASK	(0xFF << BCH_BHEA_ZB_BIT)
...
do {									\
	REG_BCH_CR = BCH_CR_BSEL(n) | BCH_CR_ENCE | BCH_CR_BCHE;	\
	REG_BCH_CRS = BCH_CR_INIT;					\
} while(0)

#define __bch_decoding(n)						\
do {									\
	REG_BCH_CR = BCH_CR_BSEL(n) | BCH_CR_DECE | BCH_CR_BCHE;	\
	REG_BCH_CRS = BCH_CR_INIT;					\
} while(0)
...
#define __bch_bhea_set(n) \
	(REG_BCH_BHEA = (n) << BCH_BHEA_TZB_BIT | BCH_BHEA_ZBE)
#define __bch_bhea_zb() \
	((REG_BCH_BHEA & BCH_BHEA_ZB_MASK) >> BCH_BHEA_ZB_BIT)

#endif /* __MIPS_ASSEMBLER */

#endif /* __JZ4775BCH_H__ */
