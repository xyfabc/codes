...
#define I2C_FLT(n)              (I2C0_BASE + (n)*0x1000 + 0xA0)
...
#define REG_I2C_CSTT(n)		REG8(I2C_CSTT(n))
...
#define REG_I2C_TXABRT(n)      	REG32(I2C_TXABRT(n))
...
#define REG_I2C_FLT(n)          REG8(I2C_FLT(n)) 
...
#define I2C_NORMAL_MASK		(I2C_INTM_MRXUF | I2C_INTM_MTXOF |  \
						I2C_INTM_MTXABT | I2C_INTM_MISTP | I2C_INTM_MISTT)

/* #define I2C_NORMAL_MASK		(I2C_INTM_MRXUF | I2C_INTM_MRXOF | I2C_INTM_MTXOF | I2C_INTM_MRXFL | \ */
/* 						I2C_INTM_MTXABT | I2C_INTM_MISTP | I2C_INTM_MISTT) */
...
#define I2C_SDAHD_HOLD_TIME_MASK	0xffff
...
#define __i2c_enable(n)		( REG_I2C_ENB(n) |= I2C_ENB_I2CENB )
#define __i2c_disable(n)       	( REG_I2C_ENB(n) &= (~I2C_ENB_I2CENB) )

#define __i2c_is_enable(n)       ( REG_I2C_ENSTA(n) & I2C_ENSTA_I2CEN )
#define __i2c_is_disable(n)      ( !(REG_I2C_ENSTA(n) & I2C_ENSTA_I2CEN) )
