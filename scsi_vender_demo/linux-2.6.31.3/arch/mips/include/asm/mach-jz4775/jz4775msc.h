...
#define MSC_DBG(n)              (MSC0_BASE + (n)*0x10000 + 0x0fc)
#define MSC_DMAC(n)             (MSC0_BASE + (n)*0x10000 + 0x044)
#define MSC_DMANDA(n)           (MSC0_BASE + (n)*0x10000 + 0x048)
#define MSC_DMADA(n)            (MSC0_BASE + (n)*0x10000 + 0x04c)
#define MSC_DMALEN(n)           (MSC0_BASE + (n)*0x10000 + 0x050)
#define MSC_DMACMD(n)           (MSC0_BASE + (n)*0x10000 + 0x054)
#define MSC_CTRL2(n)            (MSC0_BASE + (n)*0x10000 + 0x058)
#define MSC_RTCNT(n)            (MSC0_BASE + (n)*0x10000 + 0x05c)
#define MSC_DEBUG(n)            (MSC0_BASE + (n)*0x10000 + 0x0fc)
...
#define REG_MSC_DBG(n)          REG32(MSC_DBG(n))
#define REG_MSC_DMAC(n)         REG32(MSC_DMAC(n))
#define REG_MSC_DMANDA(n)       REG32(MSC_DMANDA(n))
#define REG_MSC_DMADA(n)        REG32(MSC_DMADA(n))
#define REG_MSC_DMALEN(n)       REG32(MSC_DMALEN(n))
#define REG_MSC_DMACMD(n)       REG32(MSC_DMACMD(n))
#define REG_MSC_CTRL2(n)        REG32(MSC_CTRL2(n))  
#define REG_MSC_RTCNT(n)        REG32(MSC_RTCNT(n))
#define REG_MSC_DEBUG(n)        REG32(MSC_DEBUG(n))
...
#define __msc_mask_dmaend(n) 		( REG_MSC_IMASK(n) |= MSC_IMASKS_DMAEND )
