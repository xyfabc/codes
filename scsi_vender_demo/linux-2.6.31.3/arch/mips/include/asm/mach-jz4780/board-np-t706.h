/*
 *  linux arch/mips/include/asm/mach-jz4780/board-f4780.h
 *
 *  JZ4780-based F4780 board ver 1.x definition.
 *
...
#ifndef __ASM_JZ4780_NP_T706_H__
#define __ASM_JZ4780_NP_T706_H__
...
#define GPIO_SD0_VCC_EN_N	GPE(3)
#define GPIO_SD0_CD_N		GPF(20)
#define GPIO_SD0_WP_N		GPF(21)
#define GPIO_SD1_VCC_EN_N	GPF(10)
...
#define GPIO_LCD_PWM   		(32*4+0) /* GPE4 PWM4 */
...
#define LCD_VCC_N       (32*1 + 23)    /*lcd vcc en PB23*/

/* 100 level: 0,1,...,100 */

#define __lcd_set_backlight_level(n)	\
do {					\
	__gpio_as_output1(LCD_VCC_N);	\
	__gpio_as_output1(GPIO_LCD_PWM); \
} while (0)

#define __lcd_close_backlight()		\
do {					\
	__gpio_as_output0(LCD_VCC_N);	\
...
#endif /* __ASM_JZ4780_NP_T706_H__ */
