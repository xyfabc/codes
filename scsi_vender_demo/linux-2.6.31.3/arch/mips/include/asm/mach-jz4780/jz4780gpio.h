...
/*I2c3 : PD 10 and 11 func 1 */
#define __gpio_as_i2c3()                                \
	do {                                            \
		REG_GPIO_PXINTC(3) = 0x00000C00;        \
		REG_GPIO_PXMASKC(3) = 0x00000C00;       \
		REG_GPIO_PXPAT1C(3) = 0x00000C00;       \
		REG_GPIO_PXPAT0S(3) = 0x00000C00;       \
	} while(0)
/*I2c4 : PE 3 and 4 func 1 */
#define __gpio_as_i2c4_io0()                            \
	do {                                            \
		REG_GPIO_PXINTC(4) = 0x00000018;        \
		REG_GPIO_PXMASKC(4) = 0x00000018;       \
		REG_GPIO_PXPAT1C(4) = 0x00000018;       \
		REG_GPIO_PXPAT0S(4) = 0x00000018;       \
	} while(0)
/* I2c4 : PE 12 and 13 fun 1 */
#define __gpio_as_i2c4_io1()                            \
	do {                                            \
...
/* I2c 4 : PF 24 and 25 fun 1 */
#define __gpio_as_i2c4_io2()                            \
	do {                                            \
		REG_GPIO_PXINTC(5) = 0x03000000;        \
		REG_GPIO_PXMASKC(5) = 0x03000000;       \
		REG_GPIO_PXPAT1C(5) = 0x03000000;       \
		REG_GPIO_PXPAT0S(5) = 0x03000000;       \
	} while(0)
/*by zli */
/*
 * PWM0
