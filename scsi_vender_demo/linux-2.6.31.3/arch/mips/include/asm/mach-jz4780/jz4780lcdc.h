/*
 * linux/include/asm-mips/mach-jz4780/jz4780lcdc.h
 *
 * JZ4780 LCDC register definition.
 *
 * Copyright (C) 2010 Ingenic Semiconductor Co., Ltd.
 */

#ifndef __JZ4780LCDC_H__
#define __JZ4780LCDC_H__

#define	LCD0_BASE	0xB3050000
#define	LCD1_BASE	0xB30A0000
#define	SLCD_BASE	0xB30A0000
...
#define LCD_BGC1(n)	(LCD0_BASE + (n)*0x50000 + 0x24C) /* LCD fg1 Background Color Register */
...
#define LCD_ENHCFG(n)      (LCD0_BASE + (n)*0x50000 + 0x400)
#define LCD_CSCCFG(n)      (LCD0_BASE + (n)*0x50000 + 0x404)
#define LCD_LUMMACFG(n)    (LCD0_BASE + (n)*0x50000 + 0x408)
#define LCD_CHROCFG0(n)    (LCD0_BASE + (n)*0x50000 + 0x40c)
#define LCD_CHROCFG1(n)    (LCD0_BASE + (n)*0x50000 + 0x410)
#define LCD_DITHERCFG(n)   (LCD0_BASE + (n)*0x50000 + 0x414)
#define LCD_ENHSTATUS(n)   (LCD0_BASE + (n)*0x50000 + 0x418)
/*
#define LCD_GAMMA(n)    (LCD0_BASE + (n)*0x50000 + 0x800 + n*4)
#define LCD_VEE(n)      (LCD0_BASE + (n)*0x50000 + 0x1000 + n*4) 
*/
...
#define REG_LCD_OSDCTRL(n)	REG16(LCD_OSDCTRL(n))
#define REG_LCD_OSDS(n)	REG16(LCD_OSDS(n))
...
#define REG_LCD_ALPHA(n)	REG16(LCD_ALPHA(n))
...
#define REG_LCD_RGBC(n)	REG16(LCD_RGBC(n))
