...
#ifndef __JZ4780LVDS_H__
#define __JZ4780LVDS_H__

#define LVDS_CTRL	(LCD1_BASE + 0x3C0)  /* SLCD Configure Register */
#define LVDS_PLL0	(LCD1_BASE + 0x3C4)  /* SLCD Control Register */
#define LVDS_PLL1	(LCD1_BASE + 0x3C8)  /* SLCD Status Register */
