/*
 * linux/include/asm-mips/mach-jz4780/jz4780mcu.h
 *
 * JZ4780 PDMA MCU register definition.
 *
 * Copyright (C) 2010 Ingenic Semiconductor Co., Ltd.
 */

#ifndef __JZ4780MCU_H__
#define __JZ4780MCU_H__
...
{	
	int i;	
	for (i = 0; i < NUM_MCU; i++)	
		if ( REG_MCU_DMINT & (1 << (i + 16 )))
			return i;
	return -1;
}

#endif /* __JZ4780MCU_H__ */
