/*
 * linux/arch/mips/jz4775/dma.c
 *
 * Support functions for the JZ4775 internal DMA channels.
...
//#define JZ4775_DMAC_TEST_ENABLE
#undef JZ4775_DMAC_TEST_ENABLE

#ifdef JZ4775_DMAC_TEST_ENABLE
...
static irqreturn_t jz4775_dma_irq(int irq, void *dev_id)
{
	printk("jz4775_dma_irq %d\n", irq);
...
void dma_nodesc_test(void)
{
	...
	dma_chan = jz_request_dma(DMA_ID_AUTO, "auto", jz4775_dma_irq,
				  IRQF_DISABLED, NULL);
	if (dma_chan < 0) {
