/*
 * Platform device support for Jz4775 SoC.
 *
...
/* CIM */
static struct resource jz_cim0_resources[] = {
	[0] = {
		.start	= CPHYSADDR(CIM0_BASE),
		.end	= CPHYSADDR(CIM0_BASE) + 0x1000 - 1,
		.flags	= IORESOURCE_MEM,
	},
	[1] = {
		.start	= IRQ_CIM,
...
static struct platform_device jz_cim0_device = {
	.name		= "jz_cim",
	.id		= 0,
	.num_resources	= ARRAY_SIZE(jz_cim0_resources),
	.resource	= jz_cim0_resources,
};

static struct resource jz_cim1_resources[] = {
	[0] = {
		.start	= CPHYSADDR(CIM1_BASE),
		.end	= CPHYSADDR(CIM1_BASE) + 0x1000 - 1,
		.flags	= IORESOURCE_MEM,
	},
	[1] = {
		.start	= IRQ_CIM1,
...
static struct platform_device jz_cim1_device = {
	.name		= "jz_cim",
	.id		= 1,
	.num_resources	= ARRAY_SIZE(jz_cim1_resources),
	.resource	= jz_cim1_resources,
};
