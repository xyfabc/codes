/*
 * linux/arch/mips/jz4780/dma.c
 *
 * Support functions for the JZ4780 internal DMA channels.
...
struct jz_dma_chan jz_dma_table[MAX_DMA_NUM] = {
	{ dev_id: DMA_ID_MCU_BCH, },	/* DMAC channel 0, reserved for Special channel */
	{ dev_id: DMA_ID_MCU_NAND, },	/* DMAC channel 1, reserved for Special channel */
	{ dev_id: DMA_ID_MCU_TCSM, },	/* DMAC channel 2 */
	{ dev_id: DMA_ID_MCU_MSG, },	/* DMAC channel 3 */
	{ dev_id: DMA_ID_MSC0, },	/* DMAC channel 4 */
	{ dev_id: -1, },		/* DMAC channel 5 --- unavailable */

	/* To avoid bug, reserved channel 6 & 7 for AIC_TX & AIC_RX */
	{ dev_id: DMA_ID_AIC_TX, },	/* DMAC channel 6 */
	{ dev_id: DMA_ID_AIC_RX, },	/* DMAC channel 7 */
	{ dev_id: DMA_ID_MSC1, },	/* DMAC channel 8, reserved for MSC1 */
	{ dev_id: -1, },		/* DMAC channel 9 */
	{ dev_id: -1, },		/* DMAC channel 10 */
	{ dev_id: -1, },		/* DMAC channel 11 --- unavailable */
};
...
//	{CPHYSADDR(TSSI_FIFO), DMA_32BIT_RX_CMD | DMA_MODE_READ, DMAC_DRSR_RS_TSSIIN},
	...
	[DMA_ID_MSC1] = {0, 0, 0},
	[DMA_ID_MSC2] = {0, 0, 0},
	[DMA_ID_MCU_BCH] = { 0, 0, 0 },
	[DMA_ID_MCU_NAND] = { 0, 0, 0 },
	[DMA_ID_MCU_TCSM] = { 0, 0, 0 },
	[DMA_ID_MCU_MSG] = { 0, 0, 0 },
...
//#define JZ4780_DMAC_TEST_ENABLE
#undef JZ4780_DMAC_TEST_ENABLE

#ifdef JZ4780_DMAC_TEST_ENABLE
...
static irqreturn_t jz4780_dma_irq(int irq, void *dev_id)
{
	printk("jz4780_dma_irq %d\n", irq);
...
void dma_nodesc_test(void)
{
	...
	dma_chan = jz_request_dma(DMA_ID_AUTO, "auto", jz4780_dma_irq,
				  IRQF_DISABLED, NULL);
	if (dma_chan < 0) {
