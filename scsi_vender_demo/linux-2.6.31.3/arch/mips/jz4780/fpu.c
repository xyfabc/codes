...
void jz4780_fpu_init(unsigned int round)
{
	unsigned int tmp;
...
//	printk("original jz4780 FCSR value: %8x\n",tmp);
...
//	printk("plan to set jz4780 FPU FCSR to %08x \n",tmp);
	__asm__ __volatile__(
		"ctc1	%0, $28 \n\t"
		:
		:"r"(tmp)
...
//	printk("jz4780 FCSR value after setting: %8x\n",tmp);

}

EXPORT_SYMBOL(jz4780_fpu_init);
