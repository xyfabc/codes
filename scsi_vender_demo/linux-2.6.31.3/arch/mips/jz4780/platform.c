...
static struct resource jz_usb_ohci_resources[] = {
	[0] = {
		.start		= CPHYSADDR(OHCI_BASE), // phys addr for ioremap
		.end		= CPHYSADDR(OHCI_BASE) + 0x10000 - 1,
...
static struct resource jz_usb_ehci_resources[] = {
	[0] = {
		.start		= CPHYSADDR(EHCI_BASE), // phys addr for ioremap
		.end		= CPHYSADDR(EHCI_BASE) + 0x10000 - 1,
		.flags		= IORESOURCE_MEM,
	},
	[1] = {
		.start		= IRQ_EHCI,
...
static struct platform_device jz_usb_ehci_device = {
	.name		= "jz-ehci",
	.id		= 0,
	.dev = {
	...
	.num_resources	= ARRAY_SIZE(jz_usb_ehci_resources),
	.resource	= jz_usb_ehci_resources,
};



/*** LCD controller ***/
static struct resource jz_lcd0_resources[] = {
	[0] = {
		.start          = CPHYSADDR(LCD0_BASE),
		.end            = CPHYSADDR(LCD0_BASE) + 0x10000 - 1,
		.flags          = IORESOURCE_MEM,
	},
	[1] = {
		.start          = IRQ_LCD0,
...
static u64 jz_lcd0_dmamask = ~(u32)0;

static struct platform_device jz_lcd0_device = {
	.name           = "jz-lcd",
	.id             = 0,
	.dev = {
		.dma_mask               = &jz_lcd0_dmamask,
		.coherent_dma_mask      = 0xffffffff,
	},
	.num_resources  = ARRAY_SIZE(jz_lcd0_resources),
	.resource       = jz_lcd0_resources,
};

static struct resource jz_lcd1_resources[] = {
	[0] = {
		.start          = CPHYSADDR(LCD1_BASE),
		.end            = CPHYSADDR(LCD1_BASE) + 0x10000 - 1,
		.flags          = IORESOURCE_MEM,
	},
	[1] = {
		.start          = IRQ_LCD1,
...
static u64 jz_lcd1_dmamask = ~(u32)0;

static struct platform_device jz_lcd1_device = {
	.name           = "jz-lcd",
	.id             = 1,
	.dev = {
		.dma_mask               = &jz_lcd1_dmamask,
		.coherent_dma_mask      = 0xffffffff,
	},
	.num_resources  = ARRAY_SIZE(jz_lcd1_resources),
	.resource       = jz_lcd1_resources,
};
...
static struct resource jz_i2c3_resources[] = {
	[0] = {
		.start          = CPHYSADDR(I2C3_BASE),
		.end            = CPHYSADDR(I2C3_BASE) + 0x1000 - 1,
		.flags          = IORESOURCE_MEM,
	},
	[1] = {
		.start          = IRQ_I2C3,
...
static struct resource jz_i2c4_resources[] = {
	[0] = {
		.start          = CPHYSADDR(I2C4_BASE),
		.end            = CPHYSADDR(I2C4_BASE) + 0x1000 - 1,
		.flags          = IORESOURCE_MEM,
	},
	[1] = {
		.start          = IRQ_I2C4,
...
/* by zli */
static struct platform_device jz_i2c3_device = {
	.name = "jz_i2c3",
	.id = 3,
	.dev = {
		.dma_mask               = &jz_i2c_dmamask,
	...
	.num_resources  = ARRAY_SIZE(jz_i2c3_resources),
	.resource       = jz_i2c3_resources,
};
static struct platform_device jz_i2c4_device = {
	.name = "jz_i2c4",
	.id = 4,
	.dev = {
		.dma_mask               = &jz_i2c_dmamask,
	...
	.num_resources  = ARRAY_SIZE(jz_i2c4_resources),
	.resource       = jz_i2c4_resources,
};
/* end zli */
...
static struct platform_device jz4780_mii_bus = {
	.name = "jz4770_mii_bus",
};
#else
...
static struct platform_device jz4780_mac_device = {
	.name = "jz4770_mac",
	.dev.platform_data = &jz4780_mii_bus,
};
#endif

#if defined(CONFIG_JZ4775_MAC) || defined(CONFIG_JZ4775_MAC_MODULE)
#ifndef CONFIG_MDIO_GPIO
...
static struct platform_device jz4775_mac_device = {
        .name = "jz4775_mac",
...
static struct platform_device *jz_platform_devices[] __initdata = {
	&jz_usb_ohci_device,
	&jz_usb_ehci_device,
#if defined(CONFIG_USB_MUSB_HDRC) && !defined(CONFIG_USB_DWC_OTG)
