...
MODULE_AUTHOR("tjiang <tjiang@ingenic.cn>");
 ...
 * jz_kbc_read_status() achieve in jz_kbc-****.h awake by tjiang
 */
 ...
 * bit12: 0 - none parameter 0byte; 1 - 8byt eparameter  //awake by tjiang
 */
