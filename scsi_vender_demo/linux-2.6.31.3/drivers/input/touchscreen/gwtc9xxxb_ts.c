...
{
	__gpio_as_output1(GPIO_GWTC9XXXB_RST);
	msleep(500);
	__gpio_as_output0(GPIO_GWTC9XXXB_RST);
	 msleep(500);
	__gpio_as_output1(GPIO_GWTC9XXXB_RST);
	msleep(100);
}
...
gwtc9xxxb_ts_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
	...
	//__gpio_enable_pull(GPIO_GWTC9XXXB_INT);
	__gpio_as_irq_fall_edge(GPIO_GWTC9XXXB_INT);
