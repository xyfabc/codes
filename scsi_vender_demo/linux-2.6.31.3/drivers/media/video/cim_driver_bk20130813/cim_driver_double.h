...
#define PIN_CIM_GPF5	GPA(27)  //by dy  	// modify, yjt, 20130718, PB18 -> PA27
//#define PIN_CIM_GPF5	GPE(20)  //test by dy PE20

#define PIN_CIM_I2C_SEL	GPG(8)	// add, yjt, 20130725
...
do{\
	__gpio_as_output0(PIN_CIM_GPF5);	\
