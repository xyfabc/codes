...
#define USE_7740 1   //1 for ov7740; 0 for gc0308 		// modify, yjt, 20130624, 1 -> 0
...
#define VIDIOC_G_SENSOR_REG         308
#define VIDIOC_S_SENSOR_REG         309
...
//static struct video_device *jz_sensor_gc0308;
...
static struct i2c_regvals v7725reg[] = //_640x480
{
	...
	{0x99,0x40}, 
	{0x9a,0x9e}, 
	{0x9b,0x30},//zyl,2012.4.1  0x9b,0x50,  // bright \C1\C1\B6\C8̫\B8ߣ\AC\B5\BC\D6\C2ͼ\CF񷢻ҷ\A2\B0\D7
	{0x9e,0x81}, 
	{0xa6,0x04}, 
	{0x7e,0x04}, 
	{0x7f,0x08}, 
...
#if 0
static int  jz_sensor_gc0308_init(struct i2c_client *client, int st_num)
{
	int i;
	int count;
	printk("read rgb reg!!!!!!!!!!!!!!!!!!!\n" );
