...
#define GPIO_CAMERA_PD		(32*3+8)	/* GPD8 */
#else
...
//	tvp5150_write(tvp5150_sensor_desc.client, TVP5150_AUTOSW_MSK, 0);	//reg(0x04) = 0
//	tvp5150_write(tvp5150_sensor_desc.client, TVP5150_MISC_CTL, 0x0d);	//reg(0x03) = 0x0d
//	tvp5150_write(tvp5150_sensor_desc.client, TVP5150_DATA_RATE_SEL, 0x40);	//reg(0x0d) = 0x40

//	tvp5150_write(tvp5150_sensor_desc.client, TVP5150_AUTOSW_MSK, 0xc0);	//reg(0x04) = 0xc0
	tvp5150_write(tvp5150_sensor_desc.client, TVP5150_MISC_CTL, 0x09);	//reg(0x03) = 0x09

	mdelay(5);
	printk("==>%s() L%d: reg(0x03)=0x%02x\n", __func__, __LINE__, tvp5150_read(tvp5150_sensor_desc.client, 0x03));
...
int tvp5150_sensor_probe(void)
{
	...
	printk("==>%s() L%d: msb_rom=0x%02x, lsb_rom=0x%02x\n", __func__, __LINE__, msb_rom, lsb_rom);
...
struct resolution_info tvp5150_resolution_table[] = {
	{720,486,PIXEL_FORMAT_YUV422I},	//NTSC 525/60 video systems
	{720,576,PIXEL_FORMAT_YUV422I},	//PAL  625/50 video systems
};
...
#else
	.capture_parm = {720,576, 16,PIXEL_FORMAT_YUV422I},
	.max_capture_parm = {720, 576, 16,PIXEL_FORMAT_YUV422I},

	.preview_parm = {720, 576, 16,PIXEL_FORMAT_YUV422I},
	.max_preview_parm = {720 , 576, 16,PIXEL_FORMAT_YUV422I},
#endif
	.cfg_info = {
		/* src: cb y cr y, dst: cb y cr y */
		.configure_register= 0x0
		| CIM_CFG_ORDER_2
//		| CIM_CFG_LM			/* SAV is before EAV in each line */
	...
	//	| CIM_CFG_DSM_CPM		// CCIR656 Progressive Mode
	//	| CIM_CFG_FP,			// Field Polarity for CCIR656 Progressive Mode
#endif
	},
};
