...
#define IOCTL_CIM_SET_MEM			0xf0e 	// alloc mem for buffers by app
...
//add by ylyuan
#define IOCTL_CIM_DO_SCALE			0xf18
#define	IOCTL_CIM_TEST_REG			0xf20
...
#define	CIM_OUT_FMT_MSK		0x3
#define	CIM_OUT_FMT_YUV444	0x0
#define	CIM_OUT_FMT_YUV422	0x1
#define	CIM_OUT_FMT_YUV420	0x2
		fmt:2,
		mb:1,
		reserved:28;
} cim_config_t;
