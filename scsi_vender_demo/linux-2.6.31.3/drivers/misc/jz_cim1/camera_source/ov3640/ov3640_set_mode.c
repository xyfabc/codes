...
static void night_mode(struct i2c_client *client)
{
...
static void de_night_mode(struct i2c_client *client)
{
	if(has_saved != 1)
		return;
...
static void __ov3640_set_night_mode(struct i2c_client *client,int enable)
{
	if(enable)
		night_mode(client);
	else
...
static void ov3640_set_wb_auto_mode(struct i2c_client *client)
{
	sensor_write_reg16(client,0x332b, 0x00);//AWB auto, bit[3]:0,auto
}

static void ov3640_set_wb_sunny_mode(struct i2c_client *client)
{
...
static void ov3640_set_wb_cloudy_mode(struct i2c_client *client)
{
...
static void ov3640_set_wb_office_mode(struct i2c_client *client)
{
	sensor_write_reg16(client,0x332b, 0x08);
...
static void ov3640_set_wb_home_mode(struct i2c_client *client)
{
	sensor_write_reg16(client,0x332b, 0x08);
...
static void ov3640_set_effect_antique(struct i2c_client *client)
{
...
static void ov3640_set_effect_bluish(struct i2c_client *client)
{
	sensor_write_reg16(client,0x3302, 0xef);
	sensor_write_reg16(client,0x3355, 0x18);
...
static void ov3640_set_effect_reddish(struct i2c_client *client)
{
	sensor_write_reg16(client,0x3302, 0xef);
	sensor_write_reg16(client,0x3355, 0x18);
...
static void ov3640_set_effect_yellowish(struct i2c_client *client)
{
	sensor_write_reg16(client,0x3302, 0xef);
	sensor_write_reg16(client,0x3355, 0x18);
...
static void ov3640_set_effect_greenish(struct i2c_client *client)
{
	sensor_write_reg16(client,0x3302, 0xef);
	sensor_write_reg16(client,0x3355, 0x18);
...
static void ov3640_set_effect_sepia(struct i2c_client *client)
{
	sensor_write_reg16(client,0x3302, 0xef);
	sensor_write_reg16(client,0x3355, 0x18);
	sensor_write_reg16(client,0x335a, 0x40);
...
static void ov3640_set_effect_black_white(struct i2c_client *client)
{
	sensor_write_reg16(client,0x3302, 0xef);
...
static void ov3640_set_effect_negative(struct i2c_client *client)
{
	sensor_write_reg16(client,0x3302, 0xef);
	sensor_write_reg16(client,0x3355, 0x40);//bit[6] negative
}

static void ov3640_set_effect_normal(struct i2c_client *client)
{
	sensor_write_reg16(client,0x3302, 0xef);
...
static void ov3640_set_adjust_bright (struct i2c_client *client, unsigned  int level)
{
	char val;
	val = level-4;
	val *= 16;
...
static void ov3640_ab_auto(struct i2c_client *client)
{
...
static void ov3640_ab_50hz(struct i2c_client *client)
{
	unsigned char reg3013,reg3014;
	reg3013 = sensor_read_reg16(client,0x3013);
	reg3014 = sensor_read_reg16(client,0x3014);
...
static void ov3640_ab_60hz(struct i2c_client *client)
{
	unsigned char reg3013,reg3014;
	reg3013 = sensor_read_reg16(client,0x3013);
	reg3014 = sensor_read_reg16(client,0x3014);
...
static void ov3640_ab_off(struct i2c_client *client)
{
