...
static int sensor_write_reg(struct i2c_client *client,unsigned char reg, unsigned char val)
{
	unsigned char msg[2];
	int ret;
...
static unsigned char sensor_read_reg(struct i2c_client *client,unsigned char reg)
{
	int ret;
...
static char sensor_read_reg_nostop(struct i2c_client *client, unsigned char reg)
{
	int ret;
...
#if 1
static int sensor_write_reg16(struct i2c_client *client,unsigned short reg, unsigned char val)
{
...
static unsigned char sensor_read_reg16(struct i2c_client *client,unsigned short reg)
{
	unsigned char retval;
