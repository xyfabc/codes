...
//int jz_mmc_start_scatter_dma(struct jz_mmc_host *host, struct scatterlist *sg, unsigned int sg_len) ;
int jz_mmc_start_scatter_dma(struct jz_mmc_host *host, struct scatterlist *sg, unsigned int sg_len, int mode) ;
#else
int jz_mmc_start_scatter_dma(int chan, struct jz_mmc_host *host,struct scatterlist *sg, unsigned int sg_len, int mode) ;
//int jz_mmc_start_scatter_dma(int chan, struct jz_mmc_host *host, int len, unsigned int paddr, int mode) ;
