...
#elif defined(CONFIG_SOC_JZ4775) || defined(CONFIG_SOC_JZ4780)

#if defined(CONFIG_JZ_SDMA)
#define JZ_MSC_DMA_DESC struct jz4780_msc_dma_desc
#else 
#define JZ_MSC_DMA_DESC jz_dma_desc_8word
#endif
...
struct jz4780_msc_dma_desc {
	unsigned int next_desc; 	/* LCDDAx */
	unsigned int data_addr;   	/* LCDSAx */
	unsigned int len;  	/* LCDFIDx */ 
