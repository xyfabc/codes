...
#if defined(CONFIG_JZ4780_SLCD_KGM701A3_TFT_SPFD5420A)
...
//#define PIN_RESET_N 	(32*5+12)	/* LCD_REV GPF6 nor data0 */
#elif defined(CONFIG_JZ4775_F4775)
#define PIN_CS_N 	(32*2+11)	// Chip select 	//GPc11;
#define PIN_RESET_N 	(32*0+0)	/* LCD_REV GPF6 nor data0 */
 //#define PIN_RESET_N 	(32*5+12)	/* LCD_REV GPF6 nor data0 */
#else
