...
//#endif
	...
	REG_CPM_RSR &= ~(RSR_PR | RSR_WR | RSR_P0R);
...
#endif
//#ifdef CONFIG_SOC_JZ4740
		//return put_user(REG_RTC_HWRSR, (int *) arg);RTC_HWRSR
		return put_user(RTC_HWRSR, (int *) arg);
//#endif
